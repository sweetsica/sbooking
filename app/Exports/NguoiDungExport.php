 ...
 *
 * Phạm vi = CHỈ user thuộc cơ sở hiện tại. KHÔNG kèm bác sĩ / admin cơ sở khác,
 * cũng KHÔNG kèm tài khoản toàn hệ thống (co_so_id null).
 *
