...
@php
    ...
    // Ưu tiên tô màu theo trạng thái KHÁCH (đến đúng giờ / muộn / hủy) — thắng cả trang_thai=tu_choi.
    // Không có trạng thái khách → fallback: rejected → đỏ nhạt, còn lại nền trắng.
...
@endphp
<tr class="transition-colors {{ $rowBg }} {{ $rowHover }}">
