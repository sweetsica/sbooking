...
<div class="min-w-0">
<h3 class="text-headline-md font-headline-md mb-1 flex items-center gap-2 flex-wrap">Kết nối SCRM {!! $tagHT !!}</h3>
<p class="text-body-sm text-on-surface-variant">Token xác thực server-to-server + whitelist host callback (chống open-redirect) giữa lara-sbooking và lara-scrm.</p>
</div>
</div>
</a>
...
<div class="min-w-0">
<h3 class="text-headline-md font-headline-md mb-1 flex items-center gap-2 flex-wrap">Nhật ký thông báo {!! $tagHT !!}</h3>
