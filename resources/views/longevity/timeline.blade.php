...
@if ($view === 'thang')
@include('partials.month-calendar', ['cells' => $monthCells, 'monthStart' => $monthStart, 'linkBase' => '/'.$coSo->slug.'/lich-hen', 'extra' => ($room ? '&phong_id='.$room->id : '').$tlStaff.$kieuQS, 'unit' => 'lịch'])
@endif
@if ($view !== 'thang')
