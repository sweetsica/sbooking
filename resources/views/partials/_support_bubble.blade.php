{{-- Bubble "?" gửi ticket hỗ trợ (bên sbooking). Chỉ hiện khi đã đăng nhập.
     2026-08-26 rewrite: bỏ Alpine (dashboard không nạp → modal luôn hiện). Vanilla JS toggle. --}}
...
<div class="fixed bottom-5 right-5 z-[9999]">
    <div class="flex items-center gap-2">
        ...
        <button type="button" onclick="document.getElementById('support-modal').style.display='flex'"
